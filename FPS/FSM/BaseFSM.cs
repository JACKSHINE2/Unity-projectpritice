...
namespace AI.FSM
{
    ...
    public  class BaseFSM :MonoBehaviour
    {
        ...
        private void Init()
        {
            ...
            BeAttackState beAttack = new BeAttackState();
            ...
            idle.AddFsmMap(FSMTriggerID.BeAttack, FSMStateID.BeAttacking);
            ...
            pursuit.AddFsmMap(FSMTriggerID.BeAttack, FSMStateID.BeAttacking);

            attack.AddFsmMap(FSMTriggerID.NoHealth, FSMStateID.Dead);
            attack.AddFsmMap(FSMTriggerID.WithOutAttack, FSMStateID.Pursuit);
            attack.AddFsmMap(FSMTriggerID.KilledPlayer, FSMStateID.Idle);
            attack.AddFsmMap(FSMTriggerID.BeAttack, FSMStateID.BeAttacking);

            beAttack.AddFsmMap(FSMTriggerID.NoHealth, FSMStateID.Dead);
            beAttack.AddFsmMap(FSMTriggerID.LosePlayer, FSMStateID.Idle);
        ...
        {
            transform.position = Vector3.MoveTowards(transform.position, target.position, Time.deltaTime * chState.moveSpeed);
    ...
    public abstract class FSMState
    {
        ...
        {
            triggerList.Remove(triggerList.Find(p => p.triggerID == triggerID));
        }
        /// <summary>
        /// 当前状态行为
        /// </summary>
