...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	void Start(){
		follow = GameObject.FindWithTag ("Enemy").transform;
        StartCoroutine(PlayerView(playerView));
	}
    ...
    public IEnumerator PlayerView(float playerTime)
    {
        yield return new WaitForSeconds(playerTime);
        follow = GameObject.FindWithTag("Player").transform;
        distanceAway = newAway;
        distanceUp = newUp;
    }
}
